...
2) Three mitochondrial genes (_cob, cox1,_ and _nad4_) in _Teleopsis dalmanni_ are evolving at a faster rate relative to the background branches (i.e. the five other insects used in the comparative study.
3) A clear signature of positive selection that was statistically signficant was detected in the _cob_ gene in Teleopsis dalmanni, as well as identifying five potential sites within this sequence under positive selection.
